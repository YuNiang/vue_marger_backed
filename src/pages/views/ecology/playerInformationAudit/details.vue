<template lang="html">
  <el-card>
    ...
    <el-form :model="ruleForm" ref="ruleForm" label-width="260px" class="rule-Form">
      ...
      <el-form-item v-if="Role === 'player'" label="游戏ID：" prop="GameName">
        <span class="ruleForm-item">{{ruleForm.GameName || '-'}}</span>
        <el-checkbox disabled v-show="ruleForm.GameID_check" class="ml40" v-model="ruleForm.GameID_check">标记问题</el-checkbox>
        <el-input disabled v-show="ruleForm.GameID_msg" v-model="ruleForm.GameID_msg" type="textarea" :maxlength=100 :rows="2" placeholder="请输入标记问题内容，限字100" />
      </el-form-item>
